      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <motion.div 
            ...
            className="lg:col-span-3 col-span-1 shape-leaf bg-white/[0.03] backdrop-blur-sm border border-white/20 p-8 flex flex-col md:flex-row items-center gap-6 relative overflow-hidden shadow-lg shadow-black/40"
          >
            {/* subtle glow */}
            ...
            <div className="relative z-10">
              ...
              <p className="text-[var(--color-brand-light)]/70 text-base leading-relaxed">Mais de 25 anos de tradição em ensino superior, com excelência reconhecida em seus cursos de graduação e pós-graduação. Um diploma de peso para sua carreira.</p>
            </div>
          </motion.div>
          ...
          <motion.div 
            ...
            className="lg:col-span-1 col-span-1 shape-leaf bg-white/[0.03] backdrop-blur-sm border border-white/20 p-8 flex flex-col justify-center items-center gap-4 relative overflow-hidden shadow-lg shadow-black/40 text-center hover:border-[var(--color-brand-secondary)]/50 transition-all group"
          >
            {/* subtle glow */}
            ...
            <div className="relative z-10">
              <h3 className="text-base md:text-lg font-bold text-[var(--color-brand-light)] font-primary uppercase tracking-wide">Nota 5 no MEC</h3>
            </div>
