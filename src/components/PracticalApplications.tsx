...
const apps = [
  ...
  {
    image: `${import.meta.env.BASE_URL}applications/app_iot.png`,
  ...
  {
    image: `${import.meta.env.BASE_URL}applications/app_cv.png`,
  ...
  {
    image: `${import.meta.env.BASE_URL}applications/app_geoportal.png`,
